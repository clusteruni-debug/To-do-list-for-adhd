...
| # | 항목 | 설명 | 난이도 |
|---|------|------|--------|
| 7 | 각 탭에서 직접 수정 | 수정 클릭 시 메인 탭 이동 없이 해당 탭에서 모달로 수정 | 중 |
| 8 | 이벤트 탭 직접 작성 | 이벤트 탭에서 바로 이벤트 추가 가능 | 중 |
| 9 | 본업 탭 직접 작성 | 본업 탭에서 일반 작업 바로 추가 | 낮음 |
| 10 | 일상/가족 탭 인라인 수정 | 해당 탭 내에서 모달로 수정 완료 | 중 |

### 🟡 추가 개선 (버그/UX)
| # | 항목 | 설명 | 난이도 |
|---|------|------|--------|
| 11 | 완료 게이지 버그 | 작업 완료 취소해도 진행률이 안 줄어듦 | 낮음 |
| 12 | 취소 기능 명확화 | 완료 취소 방법을 더 직관적으로 | 낮음 |
