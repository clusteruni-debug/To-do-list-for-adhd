...
### ✅ 최근 완료 (2026-02-05)
- [x] XSS 전수 방어 - innerHTML 35곳 escapeHtml() 적용 ✅
- [x] 반복 Task 마감일 UTC 버그 수정 (getLocalDateTimeStr 헬퍼) ✅
- [x] JSON.parse 전수 점검 (10곳 모두 try-catch 확인) ✅
- [x] 접근성 기초 (aria-label 11개 + Escape 키 모달 닫기) ✅
- [x] 4K/대형 모니터 레이아웃 (3열 + zoom 1.4) ✅
- [x] 홈 버튼/섹션 UX 라벨 정리 ✅
